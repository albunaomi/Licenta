...
public class Request {
   ...
   private List<CartItem> order;
    ...
    public Request(String phone, String name, String status, String address, String total, String paymentMethod, String date, String paymentState, List<CartItem> order) {
        this.phone = phone;
        this.name = name;
        this.status = status;
        this.address = address;
